...
describe ::Magnets::HTML::Form::Input::RadioInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Magnets::HTML::Form::Input::RadioInput 
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::RadioInput 
     
    end
    
    ::Magnets::HTML::Form::Input::RadioInput.new.instance_eval do

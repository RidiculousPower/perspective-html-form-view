...
describe ::Magnets::HTML::Form::Input::Time do
  ...
  it 'packages HTML elements for automated use in a form' do
    ...
    class ::Magnets::HTML::Form::Input::Time
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::Time
      
    end
    
    ::Magnets::HTML::Form::Input::Time.new.instance_eval do

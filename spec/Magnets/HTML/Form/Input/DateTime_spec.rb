...
describe ::Magnets::HTML::Form::Input::DateTimeInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Magnets::HTML::Form::Input::DateTimeInput 
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::DateTimeInput 
     
    end
    
    ::Magnets::HTML::Form::Input::DateTimeInput.new.instance_eval do

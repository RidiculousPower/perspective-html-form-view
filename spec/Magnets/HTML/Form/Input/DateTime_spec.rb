...
describe ::Magnets::HTML::Form::Input::DateTime do
  ...
  it 'packages HTML elements for automated use in a form' do
    ...
    class ::Magnets::HTML::Form::Input::DateTime
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::DateTime
      
    end
    
    ::Magnets::HTML::Form::Input::DateTime.new.instance_eval do

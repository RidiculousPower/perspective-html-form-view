...
describe ::Magnets::HTML::Form::Input::SearchInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Magnets::HTML::Form::Input::SearchInput 
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::SearchInput 
     
    end
    
    ::Magnets::HTML::Form::Input::SearchInput.new.instance_eval do

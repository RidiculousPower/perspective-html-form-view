...
describe ::Magnets::HTML::Form::Input::Search do
  ...
  it 'packages HTML elements for automated use in a form' do
    ...
    class ::Magnets::HTML::Form::Input::Search
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::Search
      
    end
    
    ::Magnets::HTML::Form::Input::Search.new.instance_eval do

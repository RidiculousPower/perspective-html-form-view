...
describe ::Magnets::HTML::Form::Input::CheckboxInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Magnets::HTML::Form::Input::CheckboxInput 
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::CheckboxInput 
     
    end
    
    ::Magnets::HTML::Form::Input::CheckboxInput.new.instance_eval do

...
describe ::Magnets::HTML::Form::Input::DataList do
  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Magnets::HTML::Form::Input::DataList
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::DataList
      
    end
    
    ::Magnets::HTML::Form::Input::DataList.new.instance_eval do

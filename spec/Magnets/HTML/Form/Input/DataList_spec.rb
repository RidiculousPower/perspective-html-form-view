...
describe ::Magnets::HTML::Form::Input::DataListInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Magnets::HTML::Form::Input::DataListInput 
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::DataListInput 
     
    end
    
    ::Magnets::HTML::Form::Input::DataListInput.new.instance_eval do

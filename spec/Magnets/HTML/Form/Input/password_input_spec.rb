...
describe ::Magnets::HTML::Form::Input::PasswordInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Magnets::HTML::Form::Input::PasswordInput 
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::PasswordInput 
     
    end
    
    ::Magnets::HTML::Form::Input::PasswordInput.new.instance_eval do

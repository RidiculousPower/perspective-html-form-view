...
describe ::Magnets::HTML::Form::Input::Number do
  ...
  it 'packages HTML elements for automated use in a form' do
    ...
    class ::Magnets::HTML::Form::Input::Number
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::Number
      
    end
    
    ::Magnets::HTML::Form::Input::Number.new.instance_eval do

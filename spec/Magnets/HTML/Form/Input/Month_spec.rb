...
describe ::Magnets::HTML::Form::Input::MonthInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Magnets::HTML::Form::Input::MonthInput 
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::MonthInput 
     
    end
    
    ::Magnets::HTML::Form::Input::MonthInput.new.instance_eval do

...
describe ::Magnets::HTML::Form::Input::Range do
  ...
  it 'packages HTML elements for automated use in a form' do
    ...
    class ::Magnets::HTML::Form::Input::Range
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::Range
      
    end
    
    ::Magnets::HTML::Form::Input::Range.new.instance_eval do

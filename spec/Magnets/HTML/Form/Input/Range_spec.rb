...
describe ::Magnets::HTML::Form::Input::RangeInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Magnets::HTML::Form::Input::RangeInput 
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::RangeInput 
     
    end
    
    ::Magnets::HTML::Form::Input::RangeInput.new.instance_eval do

...
describe ::Magnets::HTML::Form::Input::URL do
  ...
  it 'packages HTML elements for automated use in a form' do
    ...
    class ::Magnets::HTML::Form::Input::URL
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::URL
      
    end
    
    ::Magnets::HTML::Form::Input::URL.new.instance_eval do

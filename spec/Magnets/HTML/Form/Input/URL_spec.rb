...
describe ::Magnets::HTML::Form::Input::URLInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Magnets::HTML::Form::Input::URLInput 
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::URLInput 
     
    end
    
    ::Magnets::HTML::Form::Input::URLInput.new.instance_eval do

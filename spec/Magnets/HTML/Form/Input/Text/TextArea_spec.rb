...
describe ::Magnets::HTML::Form::Input::TextInput::TextAreaInput do
  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Magnets::HTML::Form::Input::TextInput::TextAreaInput
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::TextInput::TextAreaInput
      
    end
    
    ::Magnets::HTML::Form::Input::TextInput::TextAreaInput.new.instance_eval do

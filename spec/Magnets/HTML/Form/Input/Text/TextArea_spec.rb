...
describe ::Magnets::HTML::Form::Input::Text::TextArea do
  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Magnets::HTML::Form::Input::Text::TextArea
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::Text::TextArea
      
    end
    
    ::Magnets::HTML::Form::Input::Text::TextArea.new.instance_eval do

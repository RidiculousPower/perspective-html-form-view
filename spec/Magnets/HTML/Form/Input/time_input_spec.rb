...
describe ::Magnets::HTML::Form::Input::TimeInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Magnets::HTML::Form::Input::TimeInput 
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::TimeInput 
     
    end
    
    ::Magnets::HTML::Form::Input::TimeInput.new.instance_eval do

...
describe ::Magnets::HTML::Form::Input::ColorInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Magnets::HTML::Form::Input::ColorInput 
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::ColorInput 
     
    end
    
    ::Magnets::HTML::Form::Input::ColorInput.new.instance_eval do

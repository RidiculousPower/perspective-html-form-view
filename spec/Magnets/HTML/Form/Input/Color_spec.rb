...
describe ::Magnets::HTML::Form::Input::Color do
  ...
  it 'packages HTML elements for automated use in a form' do
    ...
    class ::Magnets::HTML::Form::Input::Color
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::Color
      
    end
    
    ::Magnets::HTML::Form::Input::Color.new.instance_eval do

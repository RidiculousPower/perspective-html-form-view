...
describe ::Magnets::HTML::Form::Input::Date do
  ...
  it 'packages HTML elements for automated use in a form' do
    ...
    class ::Magnets::HTML::Form::Input::Date
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::Date
      
    end
    
    ::Magnets::HTML::Form::Input::Date.new.instance_eval do

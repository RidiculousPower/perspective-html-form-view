...
describe ::Magnets::HTML::Form::Input::DateInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Magnets::HTML::Form::Input::DateInput 
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::DateInput 
     
    end
    
    ::Magnets::HTML::Form::Input::DateInput.new.instance_eval do

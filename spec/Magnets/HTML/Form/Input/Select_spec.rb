...
describe ::Magnets::HTML::Form::Input::SelectInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Magnets::HTML::Form::Input::SelectInput 
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::SelectInput 
     
    end
    
    ::Magnets::HTML::Form::Input::SelectInput.new.instance_eval do

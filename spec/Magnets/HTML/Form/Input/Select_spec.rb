...
describe ::Magnets::HTML::Form::Input::Select do
  ...
  it 'packages HTML elements for automated use in a form' do
    ...
    class ::Magnets::HTML::Form::Input::Select
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::Select
      
    end
    
    ::Magnets::HTML::Form::Input::Select.new.instance_eval do

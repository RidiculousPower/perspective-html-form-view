...
describe ::Magnets::HTML::Form::Input::FileUploadInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Magnets::HTML::Form::Input::FileUploadInput 
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::FileUploadInput 
     
    end
    
    ::Magnets::HTML::Form::Input::FileUploadInput.new.instance_eval do

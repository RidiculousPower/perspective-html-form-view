...
describe ::Magnets::HTML::Form::Input::TelephoneInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Magnets::HTML::Form::Input::TelephoneInput 
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::TelephoneInput 
     
    end
    
    ::Magnets::HTML::Form::Input::TelephoneInput.new.instance_eval do

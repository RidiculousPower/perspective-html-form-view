...
describe ::Magnets::HTML::Form::Input::Telephone do
  ...
  it 'packages HTML elements for automated use in a form' do
    ...
    class ::Magnets::HTML::Form::Input::Telephone
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::Telephone
      
    end
    
    ::Magnets::HTML::Form::Input::Telephone.new.instance_eval do

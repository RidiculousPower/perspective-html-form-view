...
describe ::Magnets::HTML::Form::Input::WeekInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Magnets::HTML::Form::Input::WeekInput 
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::WeekInput 
     
    end
    
    ::Magnets::HTML::Form::Input::WeekInput.new.instance_eval do

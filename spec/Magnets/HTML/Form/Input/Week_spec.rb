...
describe ::Magnets::HTML::Form::Input::Week do
  ...
  it 'packages HTML elements for automated use in a form' do
    ...
    class ::Magnets::HTML::Form::Input::Week
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::Week
      
    end
    
    ::Magnets::HTML::Form::Input::Week.new.instance_eval do

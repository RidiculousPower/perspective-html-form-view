...
describe ::Magnets::HTML::Form::Input::HiddenInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Magnets::HTML::Form::Input::HiddenInput 
      ...
      input.__view_class__.should == ::Magnets::HTML::Elements::Form::Input::HiddenInput 
     
    end
    
    ::Magnets::HTML::Form::Input::HiddenInput.new.instance_eval do

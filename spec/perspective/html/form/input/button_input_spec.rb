...
describe ::Perspective::HTML::Form::Input::ButtonInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Perspective::HTML::Form::Input::ButtonInput 
      ...
      input.__view_class__.should == ::Perspective::HTML::Elements::Form::Input::ButtonInput 
     
    end
    
    ::Perspective::HTML::Form::Input::ButtonInput.new.instance_eval do

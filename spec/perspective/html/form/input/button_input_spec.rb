...
describe ::Perspective::HTML::Form::View::Input::ButtonInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Perspective::HTML::Form::View::Input::ButtonInput 
      ...
      input.«view_class».should == ::Perspective::HTML::Elements::Form::View::Input::ButtonInput 
     
    end
    
    ::Perspective::HTML::Form::View::Input::ButtonInput.new.instance_eval do

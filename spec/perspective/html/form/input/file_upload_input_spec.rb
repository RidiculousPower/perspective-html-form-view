...
describe ::Perspective::HTML::Form::Input::FileUploadInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Perspective::HTML::Form::Input::FileUploadInput 
      ...
      input.__view_class__.should == ::Perspective::HTML::Elements::Form::Input::FileUploadInput 
     
    end
    
    ::Perspective::HTML::Form::Input::FileUploadInput.new.instance_eval do

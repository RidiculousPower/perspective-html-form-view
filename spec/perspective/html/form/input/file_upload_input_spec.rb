...
describe ::Perspective::HTML::Form::View::Input::FileUploadInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Perspective::HTML::Form::View::Input::FileUploadInput 
      ...
      input.«view_class».should == ::Perspective::HTML::Elements::Form::View::Input::FileUploadInput 
     
    end
    
    ::Perspective::HTML::Form::View::Input::FileUploadInput.new.instance_eval do

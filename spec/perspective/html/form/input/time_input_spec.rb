...
describe ::Perspective::HTML::Form::Input::TimeInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Perspective::HTML::Form::Input::TimeInput 
      ...
      input.__view_class__.should == ::Perspective::HTML::Elements::Form::Input::TimeInput 
     
    end
    
    ::Perspective::HTML::Form::Input::TimeInput.new.instance_eval do

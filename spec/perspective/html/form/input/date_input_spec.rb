...
describe ::Perspective::HTML::Form::Input::DateInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Perspective::HTML::Form::Input::DateInput 
      ...
      input.__view_class__.should == ::Perspective::HTML::Elements::Form::Input::DateInput 
     
    end
    
    ::Perspective::HTML::Form::Input::DateInput.new.instance_eval do

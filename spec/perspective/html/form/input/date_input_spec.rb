...
describe ::Perspective::HTML::Form::View::Input::DateInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Perspective::HTML::Form::View::Input::DateInput 
      ...
      input.«view_class».should == ::Perspective::HTML::Elements::Form::View::Input::DateInput 
     
    end
    
    ::Perspective::HTML::Form::View::Input::DateInput.new.instance_eval do

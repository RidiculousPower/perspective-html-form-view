...
describe ::Perspective::HTML::Form::Input::SelectInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Perspective::HTML::Form::Input::SelectInput 
      ...
      input.__view_class__.should == ::Perspective::HTML::Elements::Form::Input::SelectInput 
     
    end
    
    ::Perspective::HTML::Form::Input::SelectInput.new.instance_eval do

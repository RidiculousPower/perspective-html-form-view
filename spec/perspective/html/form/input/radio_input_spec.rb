...
describe ::Perspective::HTML::Form::View::Input::RadioInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Perspective::HTML::Form::View::Input::RadioInput 
      ...
      input.«view_class».should == ::Perspective::HTML::Elements::Form::View::Input::RadioInput 
     
    end
    
    ::Perspective::HTML::Form::View::Input::RadioInput.new.instance_eval do

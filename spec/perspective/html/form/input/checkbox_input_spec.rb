...
describe ::Perspective::HTML::Form::Input::CheckboxInput do
  ...
  it 'packages HTML elements for automated use in a form' do
    ...
    class ::Perspective::HTML::Form::Input::CheckboxInput 
      ...
      input.__view_class__.should == ::Perspective::HTML::Elements::Form::Input::CheckboxInput 
     
    end
    
    ::Perspective::HTML::Form::Input::CheckboxInput.new.instance_eval do

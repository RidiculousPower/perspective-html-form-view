...
describe ::Perspective::HTML::Form::View::Input::CheckboxInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Perspective::HTML::Form::View::Input::CheckboxInput 
      ...
      input.«view_class».should == ::Perspective::HTML::Elements::Form::View::Input::CheckboxInput 
     
    end
    
    ::Perspective::HTML::Form::View::Input::CheckboxInput.new.instance_eval do

...
describe ::Perspective::HTML::Form::View::Input::EmailInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Perspective::HTML::Form::View::Input::EmailInput 
      ...
      input.«view_class».should == ::Perspective::HTML::Elements::Form::View::Input::EmailInput 
     
    end
    
    ::Perspective::HTML::Form::View::Input::EmailInput.new.instance_eval do

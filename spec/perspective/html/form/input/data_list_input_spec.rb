...
describe ::Perspective::HTML::Form::Input::DataListInput do
  ...
  it 'packages HTML elements for automated use in a form' do
    ...
    class ::Perspective::HTML::Form::Input::DataListInput 
      ...
      input.__view_class__.should == ::Perspective::HTML::Elements::Form::Input::DataListInput 
     
    end
    
    ::Perspective::HTML::Form::Input::DataListInput.new.instance_eval do

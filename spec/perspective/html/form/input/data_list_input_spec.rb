...
describe ::Perspective::HTML::Form::View::Input::DataListInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Perspective::HTML::Form::View::Input::DataListInput 
      ...
      input.«view_class».should == ::Perspective::HTML::Elements::Form::View::Input::DataListInput 
     
    end
    
    ::Perspective::HTML::Form::View::Input::DataListInput.new.instance_eval do

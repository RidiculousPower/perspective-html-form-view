...
describe ::Perspective::HTML::Form::Input::WeekInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Perspective::HTML::Form::Input::WeekInput 
      ...
      input.__view_class__.should == ::Perspective::HTML::Elements::Form::Input::WeekInput 
     
    end
    
    ::Perspective::HTML::Form::Input::WeekInput.new.instance_eval do

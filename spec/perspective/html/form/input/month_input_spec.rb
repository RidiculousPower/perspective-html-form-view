...
describe ::Perspective::HTML::Form::Input::MonthInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Perspective::HTML::Form::Input::MonthInput 
      ...
      input.__view_class__.should == ::Perspective::HTML::Elements::Form::Input::MonthInput 
     
    end
    
    ::Perspective::HTML::Form::Input::MonthInput.new.instance_eval do

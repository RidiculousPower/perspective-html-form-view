...
describe ::Perspective::HTML::Form::View::Input::MonthInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Perspective::HTML::Form::View::Input::MonthInput 
      ...
      input.«view_class».should == ::Perspective::HTML::Elements::Form::View::Input::MonthInput 
     
    end
    
    ::Perspective::HTML::Form::View::Input::MonthInput.new.instance_eval do

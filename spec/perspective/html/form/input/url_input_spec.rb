...
describe ::Perspective::HTML::Form::View::Input::URLInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Perspective::HTML::Form::View::Input::URLInput 
      ...
      input.«view_class».should == ::Perspective::HTML::Elements::Form::View::Input::URLInput 
     
    end
    
    ::Perspective::HTML::Form::View::Input::URLInput.new.instance_eval do

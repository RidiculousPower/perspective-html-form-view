...
describe ::Perspective::HTML::Form::View::Input::TelephoneInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Perspective::HTML::Form::View::Input::TelephoneInput 
      ...
      input.«view_class».should == ::Perspective::HTML::Elements::Form::View::Input::TelephoneInput 
     
    end
    
    ::Perspective::HTML::Form::View::Input::TelephoneInput.new.instance_eval do

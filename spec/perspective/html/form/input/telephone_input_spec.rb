...
describe ::Perspective::HTML::Form::Input::TelephoneInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Perspective::HTML::Form::Input::TelephoneInput 
      ...
      input.__view_class__.should == ::Perspective::HTML::Elements::Form::Input::TelephoneInput 
     
    end
    
    ::Perspective::HTML::Form::Input::TelephoneInput.new.instance_eval do

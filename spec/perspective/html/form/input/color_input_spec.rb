...
describe ::Perspective::HTML::Form::View::Input::ColorInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Perspective::HTML::Form::View::Input::ColorInput 
      ...
      input.«view_class».should == ::Perspective::HTML::Elements::Form::View::Input::ColorInput 
     
    end
    
    ::Perspective::HTML::Form::View::Input::ColorInput.new.instance_eval do

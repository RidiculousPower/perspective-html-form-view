...
describe ::Perspective::HTML::Form::View::Input::DateTimeInput do

  
  it 'packages HTML elements for automated use in a form' do
    
    class ::Perspective::HTML::Form::View::Input::DateTimeInput 
      ...
      input.«view_class».should == ::Perspective::HTML::Elements::Form::View::Input::DateTimeInput 
     
    end
    
    ::Perspective::HTML::Form::View::Input::DateTimeInput.new.instance_eval do

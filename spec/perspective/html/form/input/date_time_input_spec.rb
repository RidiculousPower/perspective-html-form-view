...
describe ::Perspective::HTML::Form::Input::DateTimeInput do
  ...
  it 'packages HTML elements for automated use in a form' do
    ...
    class ::Perspective::HTML::Form::Input::DateTimeInput 
      ...
      input.__view_class__.should == ::Perspective::HTML::Elements::Form::Input::DateTimeInput 
     
    end
    
    ::Perspective::HTML::Form::Input::DateTimeInput.new.instance_eval do

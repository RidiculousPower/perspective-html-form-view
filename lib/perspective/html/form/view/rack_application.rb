...
module ::Perspective::HTML::Form::View::RackApplication
  ...
  def render_content
    ...
    if @request.post? || @request.get?                                                               and 
       form_route_key = ::Perspective::HTML::Form::View.«input_name_for_hidden_input_for_form_route» and
  ...
  def process_form_values( form_route_string )
    ...
    form_instance = binding_name ? ::Perspective::HTML::Form::View.form_binding_in_context( root_instance, 
                                                                                            form_route, 
                                                                                            binding_name )
                                 : root_instance
